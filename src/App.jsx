...
const EXPERIENCE = [
  ...
  },
  {
    ...
    highlights: [
      "Conducted transaction monitoring and fraud investigations using BigQuery, supporting a rapidly scaling digital banking platform",
      "Developed automated alerting systems and fraud trend reports for the risk operations team",
      "Collaborated with product and engineering to improve KYC and transaction verification workflows",
    ],
  },
  {
    ...
    highlights: [
      "Analysed high-volume transactional data across 30+ countries using Amazon Redshift, identifying fraud patterns",
      "Built SQL-based fraud detection queries and monitoring dashboards for real-time decision-making",
      "Produced regular reports for senior leadership on fraud trends, chargeback rates, and dispute outcomes",
    ],
  },
];
